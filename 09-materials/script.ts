...
const gradientTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/gradients/3.jpg`)
gradientTexture.minFilter = THREE.NearestFilter;
gradientTexture.magFilter = THREE.NearestFilter;
gradientTexture.generateMipmaps = false;

const environmentMapTexture = cubeTextureLoader.load([
  `${import.meta.env.BASE_URL}textures/environmentMaps/1/px.jpg`,
  `${import.meta.env.BASE_URL}textures/environmentMaps/1/nx.jpg`,
  `${import.meta.env.BASE_URL}textures/environmentMaps/1/py.jpg`,
  `${import.meta.env.BASE_URL}textures/environmentMaps/1/ny.jpg`,
  `${import.meta.env.BASE_URL}textures/environmentMaps/1/pz.jpg`,
  `${import.meta.env.BASE_URL}textures/environmentMaps/1/nz.jpg`,
]);
