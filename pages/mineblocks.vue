...
// Renderer
  ...
  const matcapTexture = textureLoader.load('/mineblocks/textures/matcaps/7.png');

  /**
   * Blocks Textures
   */
  const getBlockTexturePath = (name) => `/mineblocks/textures/minecraft/${name}.png`;
  const blockTextures = [
    {
      name: 'Obsidian',
      description:
...
// generate textures
  ...
  fontLoader.load('/mineblocks/fonts/dot-gothic-16-reg.json', (font) => {
