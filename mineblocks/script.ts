...
const matcapTexture = textureLoader.load(`${import.meta.env.BASE_URL}mineblocks/textures/matcaps/7.png`);

/**
 * Blocks Textures
 */
const getBlockTexturePath = (name) => `${import.meta.env.BASE_URL}mineblocks/textures/minecraft/${name}.png`;
const blockTextures = [
  {
    name: 'Obsidian',
    description:
