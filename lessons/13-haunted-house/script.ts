...
const doorColorTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/door/color.jpg`)
const doorAlphaTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/door/alpha.jpg`)
const doorAmbientOcclusionTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/door/ambientOcclusion.jpg`)
const doorNormalTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/door/normal.jpg`)
const doorMetalnessTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/door/metalness.jpg`)
const doorRoughnessTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/door/roughness.jpg`)
const doorHeightTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/door/height.jpg`)

const bricksColorTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/bricks/color.jpg`)
const bricksAmbientOcclusionTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/bricks/ambientOcclusion.jpg`)
const bricksNormalTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/bricks/normal.jpg`)
const bricksRoughnessTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/bricks/roughness.jpg`)

const grassColorTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/grass/color.jpg`)
const grassAmbientOcclusionTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/grass/ambientOcclusion.jpg`)
const grassNormalTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/grass/normal.jpg`)
const grassRoughnessTexture = textureLoader.load(`${import.meta.env.BASE_URL}textures/14/bricks/roughness.jpg`)
